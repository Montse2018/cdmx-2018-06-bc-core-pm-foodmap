...
- **Información;** Se les brindara información de restaurantes según su localización.
...
# BENCHMARK
#### Para elaborar esta tabla de comparacion se tomo en cuenta las aplicaciones que existen para localizar restaurantes cerca de tu ubicación.
#### Los resultados que se encontraron realizando una comparativa entre las aplicaciones encontradas fueron los siguientes:


Nombre app mobile |           CREsI      |
-------------     | ---------------------|
Nombre app        |El Tenedor            |
...
-------------     | ---------------------|
Nombre app mobile |Restaurantes.com      |
